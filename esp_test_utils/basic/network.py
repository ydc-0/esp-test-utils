...
class NetTools:
    ...
    @staticmethod
    def get_all_ips_from_interface(
        interface: str, family: AddressFamily = socket.AF_INET, prefix: str = ''
    ) -> List[str]:
    ...
    @classmethod
    def get_ip4_from_interface(cls, interface: str = '') -> str:
        ...
        """
        return cls.get_all_ips_from_interface(interface, socket.AF_INET)[0]

    @classmethod
    def get_ip6_from_interface(cls, interface: str = '', prefix: str = '') -> str:
        ...
        """
        return cls.get_all_ips_from_interface(interface, socket.AF_INET6, prefix=prefix)[0]
